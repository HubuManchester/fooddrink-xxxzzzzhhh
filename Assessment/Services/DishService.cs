        ...
        private List<Dish> GenerateDefaultDishes()
        {
            return new List<Dish>
            {
                ...
                new Dish
                {
                    ...
                    Price = 45.00m, ImageName = "dongporou.jpg", Rating = 4.7, IsSpicy = false, PrepTimeMinutes = 60
                },
                new Dish
                {
                    ...
                    Price = 48.00m, ImageName = "shuizhuyu.jpg", Rating = 4.8, IsSpicy = true, PrepTimeMinutes = 25
                },
                new Dish
                {
                    ...
                    Price = 32.00m, ImageName = "tangculiji.jpg", Rating = 4.5, IsSpicy = false, PrepTimeMinutes = 20
                },
                new Dish
                {
                    ...
                    Price = 25.00m, ImageName = "xiajiao.jpg", Rating = 4.8, IsSpicy = false, PrepTimeMinutes = 15
                },
                new Dish
                {
                    ...
                    Price = 30.00m, ImageName = "huiguorou.jpg", Rating = 4.6, IsSpicy = true, PrepTimeMinutes = 20
                },
                new Dish
                {
                ...
                new Dish
                {
                    ...
                    Price = 52.00m, ImageName = "suancaiyu.jpg", Rating = 4.8, IsSpicy = true, PrepTimeMinutes = 25
                },
                new Dish
                {
                    ...
                    Price = 42.00m, ImageName = "shizitou.jpg", Rating = 4.5, IsSpicy = false, PrepTimeMinutes = 40
                },
                new Dish
                {
                    ...
                    Price = 20.00m, ImageName = "xiaolongbao.jpg", Rating = 4.8, IsSpicy = false, PrepTimeMinutes = 20
                },
                new Dish
                {
                    ...
                    Price = 18.00m, ImageName = "lanzhoulamian.jpg", Rating = 4.5, IsSpicy = false, PrepTimeMinutes = 10
                },
                new Dish
                {
                    ...
                    Price = 35.00m, ImageName = "chashao.jpg", Rating = 4.7, IsSpicy = false, PrepTimeMinutes = 50
                },
                new Dish
                {
                ...
                new Dish
                {
                    ...
                    Price = 36.00m, ImageName = "laziji.jpg", Rating = 4.7, IsSpicy = true, PrepTimeMinutes = 25
                },
                new Dish
                {
                    ...
                    Price = 30.00m, ImageName = "guobaorou.jpg", Rating = 4.6, IsSpicy = false, PrepTimeMinutes = 20
                },
                new Dish
                {
                    ...
                    Price = 32.00m, ImageName = "baozhifan.jpg", Rating = 4.7, IsSpicy = false, PrepTimeMinutes = 25
                }
            };
        }
    }
